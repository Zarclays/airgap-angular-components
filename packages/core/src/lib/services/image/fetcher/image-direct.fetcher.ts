import { RawData } from '@zarclays/zgap-coinlib-core/utils/remote-data/RemoteData'
import { RemoteDataFactory } from '@zarclays/zgap-coinlib-core/utils/remote-data/RemoteDataFactory'
